...
Outputs bk_comparison.pdf/.png (normalized histogram + CDF panels) and prints
...
def main():
    ...
    ap.add_argument("--out", default="bk_comparison.pdf")
    args = ap.parse_args()
    ...
    axh.legend(frameon=False, fontsize=8.5)
    ...
    axc.set_title("cumulative", fontsize=10)
    ...
    fig.suptitle("B$-$K color: ROMULUS simulations vs. observed nearby galaxies",
                 fontsize=12)
